...
public class Shadows
{
    ...
    //已存储的可投射阴影的非定向光数量
    public int shadowedOtherLightCount;
    ...
    static int otherShadowViewProjectionMatricesId = Shader.PropertyToID("_OtherShadowViewProjectionMatrices");
	...
	static int otherLightShadowDepthDataId = Shader.PropertyToID("_OtherLightShadowDepthData");  
    ...
    //存储非定向光源的深度信息
    static Vector4[] otherLightShadowDepthData = new Vector4[maxShadowedOtherLightCount];

	static int shadowDistanceFadeId = Shader.PropertyToID("_ShadowDistanceFade");
	static int shadowPancakingId = Shader.PropertyToID("_ShadowPancaking");
	static int shadowAtlasSizeId = Shader.PropertyToID("_ShadowAtlasSize");
	static int pcssSearchRadiusId = Shader.PropertyToID("_PcssSearchRadius");
    static int pcssFilterRadiusId = Shader.PropertyToID("_PcssFilterRadius");
    ...
    //定向光源的PCF滤波模式
    static string[] otherPCSSKeywords = {
	    "_PCSS_OFF",
	    "_PCSS_ON",
    };
    ...
    static Matrix4x4[] otherShadowViewProjectionMatrices = new Matrix4x4[maxShadowedOtherLightCount];
    ...
    public void Render()
    {
        ...
        //设置PCSS参数
        buffer.SetGlobalFloat(pcssSearchRadiusId, settings.other.pcssSearchRadius);
        buffer.SetGlobalFloat(pcssFilterRadiusId, settings.other.pcssFilterRadius);
    ...
    void RenderOtherShadows()
    {
        ...
        buffer.SetGlobalMatrixArray(otherShadowViewProjectionMatricesId, otherShadowViewProjectionMatrices);
        buffer.SetGlobalVectorArray(otherShadowTilesId, otherShadowTiles);
        buffer.SetGlobalVectorArray(otherLightShadowDepthDataId, otherLightShadowDepthData);
        SetKeywords(otherFilterKeywords, (int)settings.other.filter - 1);
        SetKeywords(otherPCSSKeywords, (int)settings.other.PCSS);
    ...
    void RenderSpotShadows(int index, int split, int tileSize)
    {
        ...
        otherLightShadowDepthData[index].x = frustumPlanes.zNear;
        otherLightShadowDepthData[index].y = frustumPlanes.zFar;
        otherLightShadowDepthData[index].z = frustumPlanes.right;
        otherLightShadowDepthData[index].w = frustumPlanes.top;
        ...
        otherShadowViewProjectionMatrices[index] = projectionMatrix * viewMatrix;
        //得到从世界空间到阴影纹理图块空间的转换矩阵
    ...
    void RenderPointShadows(int index, int split, int tileSize)
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            otherShadowViewProjectionMatrices[tileIndex] = projectionMatrix * viewMatrix;
            //得到从世界空间到阴影纹理图块空间的转换矩阵
            otherShadowMatrices[tileIndex] = ConvertToAtlasMatrix(projectionMatrix * viewMatrix, offset, tileScale);
            //设置深度图的远近平面
            FrustumPlanes frustumPlanes = projectionMatrix.decomposeProjection;
            otherLightShadowDepthData[tileIndex].x = frustumPlanes.zNear;
            otherLightShadowDepthData[tileIndex].y = frustumPlanes.zFar;
            otherLightShadowDepthData[tileIndex].z = frustumPlanes.right;
            otherLightShadowDepthData[tileIndex].w = frustumPlanes.top;
    ...
    {
        float border = (1.0f / atlasSizes.z) * 0.5f;
        Vector4 data;
